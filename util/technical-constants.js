...
/**
 * Viewport Configurations - Screen resolutions for browser testing
 * Common resolutions: Desktop, tablet, mobile viewports
 */
...
/**
 * Encoding Types - Character encodings for text processing
 */
export const encoding = {
  utf8: 'utf-8', // Unicode encoding (most common)
  ascii: 'ascii', // ASCII encoding (English only)
